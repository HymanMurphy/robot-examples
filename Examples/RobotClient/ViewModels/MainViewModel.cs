...
namespace RobotHmi.ViewModels
{
    ...
    public class MainViewModel : SubscriptionBase
    {
        ...
        [MonitoredItem(nodeId: "ns=2;i=8"/*, dataChangeTrigger: DataChangeTrigger.StatusValueTimestamp*/)]
        ...
        [MonitoredItem(nodeId: "ns=2;i=1", attributeId: AttributeIds.EventNotifier)]
        ...
        public ICommand Robot1ModeOffCommand
        {
            get
            {
                return new DelegateCommand(async () =>
                {
                    ...
                    {
                        Debug.WriteLine("Error writing to NodeId {0} : {1}", "ns=2;i=3", ex.Message);
                    }
                });
            }
        }
                    ...
                    try
                    {
                        ...
                        var response = await this.InnerChannel.CallAsync(new CallRequest
                        {
                            MethodsToCall = new[]
                            {
                                ...
                                {
                                    ObjectId = NodeId.Parse("ns=2;i=1"),
                                    MethodId = NodeId.Parse("ns=2;i=12"),
