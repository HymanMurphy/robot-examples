...
Status_t ServiceFault_t::EncodeBody(ICodec_t& encoder, IBuffer_t& buffer) const
{
...
Status_t ServiceFault_t::Decode(const IBuffer_t& buffer, ICodec_t& decoder, ServiceFault_t& result)
{
