...
namespace uasdk
{
	const uasdk::RegisteredServer_t& RegisterServerRequest_t::Server() const
	{
		return server;
	}


	uasdk::RegisteredServer_t& RegisterServerRequest_t::Server()
	{
		return server;
	}

Status_t RegisterServerRequest_t::EncodeBody(ICodec_t& encoder, IBuffer_t& buffer) const
{
...
Status_t RegisterServerRequest_t::Decode(const IBuffer_t& buffer, ICodec_t& decoder, RegisterServerRequest_t& result)
{
