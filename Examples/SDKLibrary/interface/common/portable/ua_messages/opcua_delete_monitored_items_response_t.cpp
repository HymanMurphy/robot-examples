...
#include "opcua_delete_monitored_items_response_t.h"
...
Status_t DeleteMonitoredItemsResponse_t::EncodeBody(ICodec_t& encoder, IBuffer_t& buffer) const
{
...
Status_t DeleteMonitoredItemsResponse_t::Decode(const IBuffer_t& buffer, ICodec_t& decoder, DeleteMonitoredItemsResponse_t& result)
{
