...
#include "opcua_browse_next_response_t.h"

namespace uasdk
{

Status_t BrowseNextResponse_t::EncodeBody(ICodec_t& encoder, IBuffer_t& buffer) const
{
...
Status_t BrowseNextResponse_t::Decode(const IBuffer_t& buffer, ICodec_t& decoder, BrowseNextResponse_t& result)
{
