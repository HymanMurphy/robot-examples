...
Status_t DeleteMonitoredItemsRequest_t::EncodeBody(ICodec_t& encoder, IBuffer_t& buffer) const
{
...
Status_t DeleteMonitoredItemsRequest_t::Decode(const IBuffer_t& buffer, ICodec_t& decoder, DeleteMonitoredItemsRequest_t& result)
{
