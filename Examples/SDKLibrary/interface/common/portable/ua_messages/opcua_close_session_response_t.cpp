...
#include "opcua_close_session_response_t.h"

namespace uasdk
{

Status_t CloseSessionResponse_t::EncodeBody(ICodec_t& encoder, IBuffer_t& buffer) const
{
...
Status_t CloseSessionResponse_t::Decode(const IBuffer_t& buffer, ICodec_t& decoder, CloseSessionResponse_t& result)
{
