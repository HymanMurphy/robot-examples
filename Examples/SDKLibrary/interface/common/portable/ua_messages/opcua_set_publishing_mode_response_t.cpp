...
#include "opcua_set_publishing_mode_response_t.h"
...
Status_t SetPublishingModeResponse_t::EncodeBody(ICodec_t& encoder, IBuffer_t& buffer) const
{
...
Status_t SetPublishingModeResponse_t::Decode(const IBuffer_t& buffer, ICodec_t& decoder, SetPublishingModeResponse_t& result)
{
