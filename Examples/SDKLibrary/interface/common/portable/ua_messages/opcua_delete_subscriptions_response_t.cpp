...
#include "opcua_delete_subscriptions_response_t.h"
...
Status_t DeleteSubscriptionsResponse_t::EncodeBody(ICodec_t& encoder, IBuffer_t& buffer) const
{
...
Status_t DeleteSubscriptionsResponse_t::Decode(const IBuffer_t& buffer, ICodec_t& decoder, DeleteSubscriptionsResponse_t& result)
{
