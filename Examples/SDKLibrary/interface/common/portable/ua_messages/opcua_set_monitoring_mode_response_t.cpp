...
#include "opcua_set_monitoring_mode_response_t.h"
...
Status_t SetMonitoringModeResponse_t::EncodeBody(ICodec_t& encoder, IBuffer_t& buffer) const
{
...
Status_t SetMonitoringModeResponse_t::Decode(const IBuffer_t& buffer, ICodec_t& decoder, SetMonitoringModeResponse_t& result)
{
