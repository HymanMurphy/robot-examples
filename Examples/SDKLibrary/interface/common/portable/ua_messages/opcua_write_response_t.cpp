...
#include "opcua_write_response_t.h"

namespace uasdk
{

Status_t WriteResponse_t::EncodeBody(ICodec_t& encoder, IBuffer_t& buffer) const
{
...
Status_t WriteResponse_t::Decode(const IBuffer_t& buffer, ICodec_t& decoder, WriteResponse_t& result)
{
