...
Status_t RegisterServerResponse_t::EncodeBody(ICodec_t& encoder, IBuffer_t& buffer) const
{
...
Status_t RegisterServerResponse_t::Decode(const IBuffer_t& buffer, ICodec_t& decoder, RegisterServerResponse_t& result)
{
