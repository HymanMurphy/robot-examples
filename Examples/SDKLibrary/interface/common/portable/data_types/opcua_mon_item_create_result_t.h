...
#ifndef _OPCUA_MON_ITEM_CREATE_RESULT_T_
#define _OPCUA_MON_ITEM_CREATE_RESULT_T_
...
/*****************************************************************************/
/** \brief MonItemCreateResult_t
 *
 * This class implements the Monitor Item Create Result data type
 *
 */
class MonItemCreateResult_t : public Structure_t
{
public:
  UA_DECLARE_RUNTIME_TYPE(MonItemCreateResult_t);
private:
...
public:
   ...
   * Data type ID
   */
  static const uint32_t TYPE_ID = OpcUaId_MonitoredItemCreateResult;

  /*****************************************************************************/
  /** Destructor for the class.
   *
   */
  virtual ~MonItemCreateResult_t();
  ...
  /** = operator overloading
   *
   * @param[in] const MonItemCreateResult_t& obj
   * Object to be assigned
   *
   * @return
   * Reference to the Monitor Item Create Result object assigned
   */
  bool operator==(MonItemCreateResult_t const & obj) const;
  ...
  /** > operator overloading
   *
   * @param[in] MonItemCreateResult_t const & obj
   * Object to be compared with
   *
   * @return
   * True indicates that the LHS MonItemCreateResult_t object is greater than RHS MonItemCreateResult_t object
   */
  bool operator>(MonItemCreateResult_t const & obj) const;
  ...
  /** Copy from the source
   *
   * @param[in] const MonItemCreateResult_t& source
   *  Monitor Item Create Result source to copy from
   *
   * @return
   * Status of the operation
   */
  Status_t CopyFrom(const MonItemCreateResult_t& source);
   ...
   *
   * @param[out] MonItemCreateResult_t& result
   * Decoded Monitor Item Create Result object
   *
   * @return
   * Returns status of the operation
   */
  static Status_t Decode(const IBuffer_t& buffer, ICodec_t& decoder, MonItemCreateResult_t& result);
};
...
#endif // _OPCUA_MON_ITEM_CREATE_RESULT_T_  
