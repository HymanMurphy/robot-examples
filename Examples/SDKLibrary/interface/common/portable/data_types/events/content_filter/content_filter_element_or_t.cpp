...
UA_DEFINE_RUNTIME_TYPE(ContentFilterElement_Or_t, ContentFilterElement_t);

ContentFilterElement_Or_t::ContentFilterElement_Or_t() : ContentFilterElement_t(FilterOperator_t::FILTER_OP_OR)
{
}

ContentFilterElement_Or_t::~ContentFilterElement_Or_t()
{
}

uint32_t  ContentFilterElement_Or_t::MinimumOperandCount(void) const
{
	return 2;
}

uint32_t  ContentFilterElement_Or_t::MaximumOperandCount(void) const
{
	return 2;
}

Status_t ContentFilterElement_Or_t::ApplyFilterElement(const INode_t& node, IContentFilter_t* filter, IntrusivePtr_t<IAttributeAccess_t>& eventAttributes, IntrusivePtr_t<IServerConfiguration_t> configuration, IntrusivePtr_t<BaseDataType_t>& evaluationResult, IntrusivePtr_t<ContentFilterElementResult_t>& elementResult, bool diagnosticsRequested)
{
	...
	IntrusivePtr_t<BaseDataType_t> value = RuntimeCast<BaseDataType_t*>(*tempValue);
	...
	LogicalTrueTableValue_t rValue = LogicalOrTruthTable(aValue, bValue);
...
Status_t ContentFilterElement_Or_t::CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const
{
	return CopyToDestination(*this, destination);
}

Status_t ContentFilterElement_Or_t::CopyFrom(const BaseDataType_t& source)
{
	IntrusivePtr_t<const ContentFilterElement_Or_t> ptr = RuntimeCast<const ContentFilterElement_Or_t*>(source);
	if (!ptr.is_set())
	{
...
Status_t ContentFilterElement_Or_t::CopyFrom(const ContentFilterElement_Or_t& source)
{
