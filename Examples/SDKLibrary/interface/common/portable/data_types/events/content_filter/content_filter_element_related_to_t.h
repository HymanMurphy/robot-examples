...
#ifndef _CONTENT_FILTER_ELEMENT_RELATED_TO_T_
#define _CONTENT_FILTER_ELEMENT_RELATED_TO_T_
...
/*****************************************************************************/
/** \brief ContentFilterElement_RelatedTo_t
*
* This class implements the RelatedTo operator in Content Filter
*
*/
class ContentFilterElement_RelatedTo_t : public ContentFilterElement_t
{
private:

	/*****************************************************************************/
	/* @var uint32_t isElemRefOfRelatedTo
	* flag to indicate if the element reference is of RelatedTo operator
	*/
	bool isElemRefOfRelatedTo;

public:
  UA_DECLARE_RUNTIME_TYPE(ContentFilterElement_RelatedTo_t);

	/*****************************************************************************/
	/** Constructor for the class.
	*
	*/
	ContentFilterElement_RelatedTo_t();

	/*****************************************************************************/
	/** Destructor for the class.
	*
	*/
	virtual ~ContentFilterElement_RelatedTo_t();
  ...
  virtual Status_t CopyFrom(const BaseDataType_t& source);
	...
	/** Copy from the source
	*
	* @param[in] const ContentFilterElement_RelatedTo_t& source
	*  ContentFilterElement_RelatedTo_t source object to copy from
	*
	* @return
	* Status of the operation
	*/
  Status_t CopyFrom(const ContentFilterElement_RelatedTo_t& source);

	/*****************************************************************************/
	/** Set the flag to indicate if the element reference is of RelatedTo operator 
	*
	* @param[in] bool flag
	*  the input bool flag
	*
	* @return void
	*/
	void IsElemRefOfRelatedTo(bool flag);
...
#endif // _CONTENT_FILTER_ELEMENT_RELATED_TO_T_
