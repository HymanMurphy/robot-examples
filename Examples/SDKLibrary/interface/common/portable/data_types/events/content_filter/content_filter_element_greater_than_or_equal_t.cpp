...
UA_DEFINE_RUNTIME_TYPE(ContentFilterElement_GreaterThanOrEqual_t, ContentFilterElement_t);

ContentFilterElement_GreaterThanOrEqual_t::ContentFilterElement_GreaterThanOrEqual_t() : ContentFilterElement_t(FilterOperator_t::FILTER_OP_GREATERTHANOREQUAL)
{
}

ContentFilterElement_GreaterThanOrEqual_t::~ContentFilterElement_GreaterThanOrEqual_t()
{
}

uint32_t  ContentFilterElement_GreaterThanOrEqual_t::MinimumOperandCount(void) const
{
	return 2;
}

uint32_t  ContentFilterElement_GreaterThanOrEqual_t::MaximumOperandCount(void) const
{
	return 2;
}

Status_t ContentFilterElement_GreaterThanOrEqual_t::ApplyFilterElement(const INode_t& node, IContentFilter_t* filter, IntrusivePtr_t<IAttributeAccess_t>& eventAttributes, IntrusivePtr_t<IServerConfiguration_t> configuration, IntrusivePtr_t<BaseDataType_t>& evaluationResult, IntrusivePtr_t<ContentFilterElementResult_t>& elementResult, bool diagnosticsRequested)
{
...
Status_t ContentFilterElement_GreaterThanOrEqual_t::CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const
{
	return CopyToDestination(*this, destination);
}

Status_t ContentFilterElement_GreaterThanOrEqual_t::CopyFrom(const BaseDataType_t& source)
{
	IntrusivePtr_t<const ContentFilterElement_GreaterThanOrEqual_t> ptr = RuntimeCast<const ContentFilterElement_GreaterThanOrEqual_t*>(source);
	if (!ptr.is_set())
	{
...
Status_t ContentFilterElement_GreaterThanOrEqual_t::CopyFrom(const ContentFilterElement_GreaterThanOrEqual_t& source)
{
