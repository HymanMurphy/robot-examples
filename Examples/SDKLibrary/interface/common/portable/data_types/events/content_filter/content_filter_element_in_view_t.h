...
#ifndef _CONTENT_FILTER_ELEMENT_IN_VIEW_T_
#define _CONTENT_FILTER_ELEMENT_IN_VIEW_T_
...
/*****************************************************************************/
/** \brief ContentFilterElement_InView_t
*
* This class implements the InView operator in Content Filter
*
*/
class ContentFilterElement_InView_t : public ContentFilterElement_t
{

public:
  UA_DECLARE_RUNTIME_TYPE(ContentFilterElement_InView_t);

	/*****************************************************************************/
	/** Constructor for the class.
	*
	*/
	ContentFilterElement_InView_t();

	/*****************************************************************************/
	/** Destructor for the class.
	*
	*/
	virtual ~ContentFilterElement_InView_t();
  ...
  virtual Status_t ApplyFilterElement(const INode_t& node, IContentFilter_t* filter, IntrusivePtr_t<IAttributeAccess_t>& eventAttributes, IntrusivePtr_t<IServerConfiguration_t> configuration, IntrusivePtr_t<BaseDataType_t>& evaluationResult, IntrusivePtr_t<ContentFilterElementResult_t>& elementResult, bool diagnosticsRequested);
	...
	*/
	...
	/** Copy from the source
	*
	* @param[in] const ContentFilterElement_InView_t& source
	*  ContentFilterElement_InView_t source object to copy from
	*
	* @return
	* Status of the operation
	*/
  Status_t CopyFrom(const ContentFilterElement_InView_t& source);

private:

	/*****************************************************************************/
	/** Find the input node in the given view
	*
	* @param[in] IntrusivePtr_t<IAddressSpace_t> addressSpace
	*  address space of the server
	*
	* @param[in] const INode_t& targetNode
	*  target node is the input node to be found in the given view
	*
	* @param[in] IntrusivePtr_t<const INode_t> &parentNode
	*  parent node of the given node
	*
	* @param[out] bool &found
	*  the flag which will indicate if the input node was found or not
	*
	* @return
	* Status of the operation
	*/
  Status_t FindNodeInView(IntrusivePtr_t<IAddressSpace_t> addressSpace, const INode_t& targetNode, IntrusivePtr_t<const INode_t> &parentNode, bool &found);
};
...
#endif // _CONTENT_FILTER_ELEMENT_IN_VIEW_T_
