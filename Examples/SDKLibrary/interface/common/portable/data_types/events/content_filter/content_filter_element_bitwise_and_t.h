...
#ifndef _CONTENT_FILTER_ELEMENT_BITWISE_AND_T_
#define _CONTENT_FILTER_ELEMENT_BITWISE_AND_T_
...
*
*/
class ContentFilterElement_BitwiseAnd_t : public ContentFilterElement_t
{
public:
  UA_DECLARE_RUNTIME_TYPE(ContentFilterElement_BitwiseAnd_t);
...
public:
	...
	*
	*/
	ContentFilterElement_BitwiseAnd_t();

	/*****************************************************************************/
	/** Destructor for the class.
	*
	*/
	virtual ~ContentFilterElement_BitwiseAnd_t();
	...
	*/
	...
	/** Copy from the source
	*
	* @param[in] const ContentFilterElement_BitwiseAnd_t& source
	*  ContentFilterElement_BitwiseAnd_t source object to copy from
	*
	* @return
	* Status of the operation
	*/
  Status_t CopyFrom(const ContentFilterElement_BitwiseAnd_t& source);

	/*****************************************************************************/
	/** Performs BitwiseAnd operation on the input values
	*
	* @param[in] IntrusivePtr_t<BaseDataType_t> value1
	*  first operand for BitwiseAnd operation
	*
	* @param[in] IntrusivePtr_t<BaseDataType_t> value2
	*  second operand for BitwiseAnd operation
	*
	* @param[out] IntrusivePtr_t<BaseDataType_t> result
	*  result of the BitwiseAnd operation
	*
	* @return
	* Status of the operation
	*/
	Status_t PerformBitwiseAndOperation(IntrusivePtr_t<BaseDataType_t> value1, IntrusivePtr_t<BaseDataType_t> value2, IntrusivePtr_t<BaseDataType_t>& evaluationResult);
...
#endif // _CONTENT_FILTER_ELEMENT_BITWISE_AND_T_
