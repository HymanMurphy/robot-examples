...
#ifndef _CONTENT_FILTER_ELEMENT_OF_TYPE_T_
#define _CONTENT_FILTER_ELEMENT_OF_TYPE_T_
...
/*****************************************************************************/
/** \brief ContentFilterElement_OfType_t
*
* This class implements the OfType operator in Content Filter
*
*/
class ContentFilterElement_OfType_t : public ContentFilterElement_t
{

public:
  UA_DECLARE_RUNTIME_TYPE(ContentFilterElement_OfType_t);

	/*****************************************************************************/
	/** Constructor for the class.
	*
	*/
	ContentFilterElement_OfType_t();

	/*****************************************************************************/
	/** Destructor for the class.
	*
	*/
	virtual ~ContentFilterElement_OfType_t();
  ...
  virtual Status_t ApplyFilterElement(const INode_t& node, IContentFilter_t* filter, IntrusivePtr_t<IAttributeAccess_t>& eventAttributes, IntrusivePtr_t<IServerConfiguration_t> configuration, IntrusivePtr_t<BaseDataType_t>& evaluationResult, IntrusivePtr_t<ContentFilterElementResult_t>& elementResult, bool diagnosticsRequested);
	...
	*/
	...
	/** Copy from the source
	*
	* @param[in] const ContentFilterElement_OfType_t& source
	*  ContentFilterElement_OfType_t source object to copy from
	*
	* @return
	* Status of the operation
	*/
  Status_t CopyFrom(const ContentFilterElement_OfType_t& source);
};
...
#endif // _CONTENT_FILTER_ELEMENT_OF_TYPE_T_
