...
#ifndef _CONTENT_FILTER_ELEMENT_GREATER_THAN_T_
#define _CONTENT_FILTER_ELEMENT_GREATER_THAN_T_
...
/*****************************************************************************/
/** \brief ContentFilterElement_GreaterThan_t
*
* This class implements the GreaterThan operator in Content Filter
*
*/
class ContentFilterElement_GreaterThan_t : public ContentFilterElement_t
{
  public:
  UA_DECLARE_RUNTIME_TYPE(ContentFilterElement_GreaterThan_t);

	/*****************************************************************************/
	/** Constructor for the class.
	*
	*/
  ContentFilterElement_GreaterThan_t();

	/*****************************************************************************/
	/** Destructor for the class.
	*
	*/
	virtual ~ContentFilterElement_GreaterThan_t();
  ...
  virtual Status_t ApplyFilterElement(const INode_t& node, IContentFilter_t* filter, IntrusivePtr_t<IAttributeAccess_t>& eventAttributes, IntrusivePtr_t<IServerConfiguration_t> configuration, IntrusivePtr_t<BaseDataType_t>& evaluationResult, IntrusivePtr_t<ContentFilterElementResult_t>& elementResult, bool diagnosticsRequested);
	...
	*/
	...
	/** Copy from the source
	*
	* @param[in] const ContentFilterElement_GreaterThan_t& source
	*  ContentFilterElement_GreaterThan_t source object to copy from
	*
	* @return
	* Status of the operation
	*/
  Status_t CopyFrom(const ContentFilterElement_GreaterThan_t& source);
...
#endif // _CONTENT_FILTER_ELEMENT_GREATER_THAN_T_
