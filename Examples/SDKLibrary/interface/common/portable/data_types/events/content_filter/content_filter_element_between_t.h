...
#ifndef _CONTENT_FILTER_ELEMENT_BETWEEN_T_
#define _CONTENT_FILTER_ELEMENT_BETWEEN_T_
...
/*****************************************************************************/
/** \brief ContentFilterElement_Between_t
*
* This class implements the Between operator in Content Filter
*
*/
class ContentFilterElement_Between_t : public ContentFilterElement_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(ContentFilterElement_Between_t);
...
public:
	...
	*
	*/
	ContentFilterElement_Between_t();

	/*****************************************************************************/
	/** Destructor for the class.
	*
	*/
	virtual ~ContentFilterElement_Between_t();
	...
	*/
	...
	/** Copy from the source
	*
	* @param[in] const ContentFilterElement_Between_t& source
	*  ContentFilterElement_Between_t source object to copy from
	*
	* @return
	* Status of the operation
	*/
	Status_t CopyFrom(const ContentFilterElement_Between_t& source);
...
#endif // _CONTENT_FILTER_ELEMENT_BETWEEN_T_
