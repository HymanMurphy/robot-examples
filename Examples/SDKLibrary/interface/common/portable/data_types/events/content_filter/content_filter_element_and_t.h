...
#ifndef _CONTENT_FILTER_ELEMENT_AND_T_
#define _CONTENT_FILTER_ELEMENT_AND_T_
...
/*****************************************************************************/
/** \brief ContentFilterElement_And_t
*
* This class implements the And operator in Content Filter
*
*/
class ContentFilterElement_And_t : public ContentFilterElement_t
{
public:
  UA_DECLARE_RUNTIME_TYPE(ContentFilterElement_And_t);
...
public:
	...
	*
	*/
	ContentFilterElement_And_t();

	/*****************************************************************************/
	/** Destructor for the class.
	*
	*/
	virtual ~ContentFilterElement_And_t();
  ...
  virtual Status_t ApplyFilterElement(const INode_t& node, IContentFilter_t* filter, IntrusivePtr_t<IAttributeAccess_t>& eventAttributes, IntrusivePtr_t<IServerConfiguration_t> configuration, IntrusivePtr_t<BaseDataType_t>& evaluationResult, IntrusivePtr_t<ContentFilterElementResult_t>& elementResult, bool diagnosticsRequested);
	...
	*/
	...
	/** Copy from the source
	*
	* @param[in] const ContentFilterElement_And_t& source
	*  ContentFilterElement_And_t source object to copy from
	*
	* @return
	* Status of the operation
	*/
  Status_t CopyFrom(const ContentFilterElement_And_t& source); 
...
#endif // _CONTENT_FILTER_ELEMENT_AND_T_
