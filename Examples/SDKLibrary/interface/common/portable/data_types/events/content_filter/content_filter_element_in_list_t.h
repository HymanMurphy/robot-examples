...
#ifndef _CONTENT_FILTER_ELEMENT_IN_LIST_T_
#define _CONTENT_FILTER_ELEMENT_IN_LIST_T_
...
/*****************************************************************************/
/** \brief ContentFilterElement_InList_t
*
* This class implements the InList operator in Content Filter
*
*/
class ContentFilterElement_InList_t : public ContentFilterElement_t
{

	IntrusivePtr_t<IServerConfiguration_t> serverConfiguration;

public:
  UA_DECLARE_RUNTIME_TYPE(ContentFilterElement_InList_t);

	/*****************************************************************************/
	/** Constructor for the class.
	*
	*/
	ContentFilterElement_InList_t();

	/*****************************************************************************/
	/** Destructor for the class.
	*
	*/
	virtual ~ContentFilterElement_InList_t();
  ...
  virtual Status_t ApplyFilterElement(const INode_t& node, IContentFilter_t* filter, IntrusivePtr_t<IAttributeAccess_t>& eventAttributes, IntrusivePtr_t<IServerConfiguration_t> configuration, IntrusivePtr_t<BaseDataType_t>& evaluationResult, IntrusivePtr_t<ContentFilterElementResult_t>& elementResult, bool diagnosticsRequested);
	...
	*/
	...
	/** Copy from the source
	*
	* @param[in] const ContentFilterElement_InList_t& source
	*  ContentFilterElement_InList_t source object to copy from
	*
	* @return
	* Status of the operation
	*/
  Status_t CopyFrom(const ContentFilterElement_InList_t& source);
...
#endif // _CONTENT_FILTER_ELEMENT_IN_LIST_T_
