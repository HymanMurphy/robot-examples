...
#ifndef _OPCUA_OBJECT_TYPE_ATTRIBUTES_T_
#define _OPCUA_OBJECT_TYPE_ATTRIBUTES_T_
...
class ObjectTypeAttributes_t : public Structure_t
{
public:
  UA_DECLARE_RUNTIME_TYPE(ObjectTypeAttributes_t);
private:
...
public:
  static const uint32_t TYPE_ID = OpcUaId_ObjectTypeAttributes;

  virtual ~ObjectTypeAttributes_t();

  virtual bool operator==(BaseDataType_t const & obj) const;

  bool operator==(ObjectTypeAttributes_t const & obj) const;
  ...
  Status_t CopyFrom(const ObjectTypeAttributes_t& source);
  ...
  static Status_t Decode(const IBuffer_t& buffer, ICodec_t& decoder, ObjectTypeAttributes_t& result);
...
#endif // _OPCUA_OBJECT_TYPE_ATTRIBUTES_T_
