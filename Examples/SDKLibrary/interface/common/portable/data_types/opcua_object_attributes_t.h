...
#ifndef _OPCUA_OBJECT_ATTRIBUTES_T_
#define _OPCUA_OBJECT_ATTRIBUTES_T_
...
class ObjectAttributes_t : public Structure_t
{
public:
  UA_DECLARE_RUNTIME_TYPE(ObjectAttributes_t);
private:
...
public:
  static const uint32_t TYPE_ID = OpcUaId_ObjectAttributes;

  virtual ~ObjectAttributes_t();

  virtual bool operator==(BaseDataType_t const & obj) const;

  bool operator==(ObjectAttributes_t const & obj) const;
  ...
  Status_t CopyFrom(const ObjectAttributes_t& source);
  ...
  static Status_t Decode(const IBuffer_t& buffer, ICodec_t& decoder, ObjectAttributes_t& result);
...
#endif // _OPCUA_OBJECT_ATTRIBUTES_T_
