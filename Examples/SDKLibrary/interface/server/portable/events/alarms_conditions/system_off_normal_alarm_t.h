...
#ifndef _SYSTEM_OFF_NORMAL_ALARM_T_
#define _SYSTEM_OFF_NORMAL_ALARM_T_
...
/*****************************************************************************/
/** \brief ISystemOffNormalAlarmTypeMethodListener_t
*
...
*
*/
class ISystemOffNormalAlarmMethodListener_t : public IOffNormalAlarmMethodListener_t
{
  //It do not have any methods. It can act as a place holder for sub-classes
};

/*****************************************************************************/
/** \brief SystemOffNormalAlarm_t
*
* This Condition is used by a Server to indicate that an underlying system
* that is providing Alarm information is having a communication problem and 
* that the Server may have invalid or incomplete Condition state in the Subscription
*
*/
class SystemOffNormalAlarm_t : public OffNormalAlarm_t
{
public:
  UA_DECLARE_RUNTIME_TYPE(SystemOffNormalAlarm_t);

private:

  /*****************************************************************************/
  /* @var IntrusivePtr_t<SystemOffNormalAlarmTypeData_t> conditionData
  * conditionData is a structure which holds all the variables of the condition.
  */
  IntrusivePtr_t<SystemOffNormalAlarmTypeData_t> conditionData;
...
protected:
  ...
  /*****************************************************************************/
  /* @var IntrusivePtr_t<ISystemOffNormalAlarmMethodListener_t> conditionMethodListener
  * conditionMethodListener is used to register for callback listeners.
  */
  IntrusivePtr_t<ISystemOffNormalAlarmMethodListener_t> conditionMethodListener;
...
public:
  ...
  *
  */
  SystemOffNormalAlarm_t();

  /*****************************************************************************/
  /** Destructor for the class.
  *
  */
  virtual ~SystemOffNormalAlarm_t();
  ...
  * status of the operation
  */
  virtual Status_t SetMethodListener(IntrusivePtr_t<ISystemOffNormalAlarmMethodListener_t> value);
...
#endif // _SYSTEM_OFF_NORMAL_ALARM_T_
