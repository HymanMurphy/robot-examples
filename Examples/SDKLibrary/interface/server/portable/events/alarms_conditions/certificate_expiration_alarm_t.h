...
#ifndef _CERTIFICATE_EXPIRATION_ALARM_T_
#define _CERTIFICATE_EXPIRATION_ALARM_T_
...
/*****************************************************************************/
/** \brief ICertificateExpirationAlarmMethodListener_t
*
...
*
*/
class ICertificateExpirationAlarmMethodListener_t : public ISystemOffNormalAlarmMethodListener_t
{
  //It do not have any methods. It can act as a place holder for sub-classes  
};

/*****************************************************************************/
/** \brief CertificateExpirationAlarm_t
*
* This SystemOffNormalAlarmType is raised by the Server when the 
* Server’s Certificate is within the ExpirationLimit of expiration.
*
*/
class CertificateExpirationAlarm_t : public SystemOffNormalAlarm_t
{
public:
  UA_DECLARE_RUNTIME_TYPE(CertificateExpirationAlarm_t);

private:

  /*****************************************************************************/
  /* @var IntrusivePtr_t<CertificateExpirationAlarmTypeData_t> conditionData
  * conditionData is a structure which holds all the variables of the condition.
  */
  IntrusivePtr_t<CertificateExpirationAlarmTypeData_t> conditionData;
...
protected:
  ...
  /*****************************************************************************/
  /* @var IntrusivePtr_t<ICertificateExpirationAlarmMethodListener_t> conditionMethodListener
  * conditionMethodListener is used to register for callback listeners.
  */
  IntrusivePtr_t<ICertificateExpirationAlarmMethodListener_t> conditionMethodListener;
...
public:
  ...
  *
  */
  CertificateExpirationAlarm_t();

  /*****************************************************************************/
  /** Destructor for the class.
  *
  */
  virtual ~CertificateExpirationAlarm_t();
  ...
  * status of the operation
  */
  virtual Status_t SetMethodListener(IntrusivePtr_t<ICertificateExpirationAlarmMethodListener_t> value);


  /*****************************************************************************/
  /** UpdateCertificateExpirationState()
  * Update the certificate expiration alarm data from actor
  *
  * @param[in] expirationDate
  * expiration Date of the certificate
  *
  * @param[in] certificateType
  * certificate Type
  *
  * @param[in] data
  * certificate data
  *
  * @param[in] expirationLimit
  * expiration Limit of the certificate
  *
  * @return
  * status of the operation
  */
  Status_t UpdateCertificateExpirationState(IntrusivePtr_t<DateTime_t> expirationDate, IntrusivePtr_t<NodeId_t> certificateType, IntrusivePtr_t<ByteString_t> data, IntrusivePtr_t<Duration_t> expirationLimit);
...
#endif // _CERTIFICATE_EXPIRATION_ALARM_T_
