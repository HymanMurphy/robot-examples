...
#ifndef _LIMIT_ALARM_T_
#define _LIMIT_ALARM_T_
...
/*****************************************************************************/
/** \brief ILimitAlarmMethodListener_t
*
...
*
*/
class ILimitAlarmMethodListener_t : public IAlarmConditionMethodListener_t
{
...
/** \brief LimitAlarm_t
*
* The LimitAlarmType is an abstract type used to provide a base Type for AlarmConditions with multiple limits.
*
*/
class LimitAlarm_t : public AlarmCondition_t
{
public:
  UA_DECLARE_RUNTIME_TYPE(LimitAlarm_t);

private:

  /*****************************************************************************/
  /* @var IntrusivePtr_t<LimitAlarmTypeData_t> conditionData
  * conditionData is a structure which holds all the variables of the condition.
  */
  IntrusivePtr_t<LimitAlarmTypeData_t> conditionData;
...
protected:
  ...
  /*****************************************************************************/
  /* @var IntrusivePtr_t<ILimitAlarmMethodListener_t> conditionMethodListener
  * conditionMethodListener is used to register for callback listeners.
  */
  IntrusivePtr_t<ILimitAlarmMethodListener_t> conditionMethodListener;
...
public:
  ...
  */
  ...
  /*****************************************************************************/
  /** InitialiseLimitValues()
  * Initialise the limit values
  *
  * @param[in] highHighLimitValue
  * highHigh Limit Value
  *
  * @param[in] highLimitValue
  * high Limit Value
  *
  * @param[in] lowLimitValue
  * low Limit Value
  *
  * @param[in] lowLowLimitValue
  * lowLow Limit Value
  *
  * @return
  * status of the operation
  */
  Status_t InitialiseLimitValues(IntrusivePtr_t<Double_t> highHighLimitValue, IntrusivePtr_t<Double_t> highLimitValue,
  ...
  * status of the operation
  */
  virtual Status_t SetMethodListener(IntrusivePtr_t<ILimitAlarmMethodListener_t> value);
