...
#ifndef _DISCRETE_ALARM_T_
#define _DISCRETE_ALARM_T_
...
/*****************************************************************************/
/** \brief IDiscreteAlarmMethodListener_t
*
...
*
*/
class IDiscreteAlarmMethodListener_t : public IAlarmConditionMethodListener_t
{
  //It do not have any methods. It can act as a place holder for sub-classes
};

/*****************************************************************************/
/** \brief DiscreteAlarm_t
*
* The DiscreteAlarmType is used to classify Types into Alarm Conditions 
* where the input for the Alarm may take on only a certain number of possible values (e.g. true/false, running/stopped/terminating).
*
*/
class DiscreteAlarm_t : public AlarmCondition_t
{
public:
  UA_DECLARE_RUNTIME_TYPE(DiscreteAlarm_t);

private:

  /*****************************************************************************/
  /* @var IntrusivePtr_t<DiscreteAlarmTypeData_t> conditionData
  * conditionData is a structure which holds all the variables of the condition.
  */
  IntrusivePtr_t<DiscreteAlarmTypeData_t> conditionData;
...
protected:
  ...
  /*****************************************************************************/
  /* @var IntrusivePtr_t<IDiscreteAlarmMethodListener_t> conditionMethodListener
  * conditionMethodListener is used to register for callback listeners.
  */
  IntrusivePtr_t<IDiscreteAlarmMethodListener_t> conditionMethodListener;
...
public:
  ...
  * status of the operation
  */
  virtual Status_t SetMethodListener(IntrusivePtr_t<IDiscreteAlarmMethodListener_t> value);
