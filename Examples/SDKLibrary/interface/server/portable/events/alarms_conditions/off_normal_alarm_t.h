...
#ifndef _OFF_NORMAL_ALARM_T_
#define _OFF_NORMAL_ALARM_T_
...
/*****************************************************************************/
/** \brief IOffNormalAlarmMethodListener_t
*
...
*
*/
class IOffNormalAlarmMethodListener_t : public IDiscreteAlarmMethodListener_t
{
  //It do not have any methods. It can act as a place holder for sub-classes
};

/*****************************************************************************/
/** \brief OffNormalAlarm_t
*
...
*
*/
class OffNormalAlarm_t : public DiscreteAlarm_t
{
public:
  UA_DECLARE_RUNTIME_TYPE(OffNormalAlarm_t);

private:

  /*****************************************************************************/
  /* @var IntrusivePtr_t<OffNormalAlarmTypeData_t> conditionData
  * conditionData is a structure which holds all the variables of the condition.
  */
  IntrusivePtr_t<OffNormalAlarmTypeData_t> conditionData;
...
protected:
  ...
  /*****************************************************************************/
  /* @var IntrusivePtr_t<IOffNormalAlarmMethodListener_t> conditionMethodListener
  * conditionMethodListener is used to register for callback listeners.
  */
  IntrusivePtr_t<IOffNormalAlarmMethodListener_t> conditionMethodListener;
...
public:
  ...
  */
  ...
  /*****************************************************************************/
  /** InitialiseNormalState()
  *initialise the normal state.
  *
  * @param[in] normalState_
  ...
  * the normal state of the Variable pointed to by the InputNode Property.
  *
  * @return
  * status of the operation
  */
  Status_t InitialiseNormalState(IntrusivePtr_t<NodeId_t> normalState_);
  ...
  * status of the operation
  */
  virtual Status_t SetMethodListener(IntrusivePtr_t<IOffNormalAlarmMethodListener_t> value);
