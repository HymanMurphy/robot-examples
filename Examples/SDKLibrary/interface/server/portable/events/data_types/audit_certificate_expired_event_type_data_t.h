...
#ifndef _AUDITCERTIFICATEEXPIREDEVENTTYPEDATA_T_H_
#define _AUDITCERTIFICATEEXPIREDEVENTTYPEDATA_T_H_
...
class AuditCertificateExpiredEventTypeData_t : public AuditCertificateEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditCertificateExpiredEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditCertificateExpiredEventType;
	
	AuditCertificateExpiredEventTypeData_t();
	virtual ~AuditCertificateExpiredEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditCertificateExpiredEventTypeData_t& source);
...
#endif /* _AUDITCERTIFICATEEXPIREDEVENTTYPEDATA_T_H_ */
