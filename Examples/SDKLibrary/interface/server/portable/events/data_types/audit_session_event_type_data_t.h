...
#ifndef _AUDITSESSIONEVENTTYPEDATA_T_H_
#define _AUDITSESSIONEVENTTYPEDATA_T_H_
...
class AuditSessionEventTypeData_t : public AuditEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditSessionEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditSessionEventType;
	
	AuditSessionEventTypeData_t();
	virtual ~AuditSessionEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditSessionEventTypeData_t& source);
...
private:
	...
	IntrusivePtr_t<NodeId_t> sessionId;
	
	

public:
	//Accessors
	IntrusivePtr_t<const NodeId_t> SessionId(void) const {return sessionId;}
	
	IntrusivePtr_t<NodeId_t> &SessionId(void) {return sessionId;}
...
#endif /* _AUDITSESSIONEVENTTYPEDATA_T_H_ */
