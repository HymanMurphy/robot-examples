...
#ifndef _AUDITCONDITIONSHELVINGEVENTTYPEDATA_T_H_
#define _AUDITCONDITIONSHELVINGEVENTTYPEDATA_T_H_
...
class AuditConditionShelvingEventTypeData_t : public AuditConditionEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditConditionShelvingEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditConditionShelvingEventType;
	
	AuditConditionShelvingEventTypeData_t();
	virtual ~AuditConditionShelvingEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditConditionShelvingEventTypeData_t& source);
...
public:
	//Accessors
	IntrusivePtr_t<const Duration_t> ShelvingTime(void) const {return shelvingTime;}
	
	IntrusivePtr_t<Duration_t> &ShelvingTime(void) {return shelvingTime;}
...
#endif /* _AUDITCONDITIONSHELVINGEVENTTYPEDATA_T_H_ */
