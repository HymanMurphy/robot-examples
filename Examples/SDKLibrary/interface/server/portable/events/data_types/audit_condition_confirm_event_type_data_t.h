...
#ifndef _AUDITCONDITIONCONFIRMEVENTTYPEDATA_T_H_
#define _AUDITCONDITIONCONFIRMEVENTTYPEDATA_T_H_
...
class AuditConditionConfirmEventTypeData_t : public AuditConditionEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditConditionConfirmEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditConditionConfirmEventType;
	
	AuditConditionConfirmEventTypeData_t();
	virtual ~AuditConditionConfirmEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditConditionConfirmEventTypeData_t& source);
...
#endif /* _AUDITCONDITIONCONFIRMEVENTTYPEDATA_T_H_ */
