...
#ifndef _EVENTQUEUEOVERFLOWEVENTTYPEDATA_T_H_
#define _EVENTQUEUEOVERFLOWEVENTTYPEDATA_T_H_
...
class EventQueueOverflowEventTypeData_t : public BaseEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(EventQueueOverflowEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_EventQueueOverflowEventType;
	
	EventQueueOverflowEventTypeData_t();
	virtual ~EventQueueOverflowEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const EventQueueOverflowEventTypeData_t& source);
...
#endif /* _EVENTQUEUEOVERFLOWEVENTTYPEDATA_T_H_ */
