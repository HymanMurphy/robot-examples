...
#ifndef _SEMANTICCHANGEEVENTTYPEDATA_T_H_
#define _SEMANTICCHANGEEVENTTYPEDATA_T_H_
...
class SemanticChangeEventTypeData_t : public BaseModelChangeEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(SemanticChangeEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_SemanticChangeEventType;
	
	SemanticChangeEventTypeData_t();
	virtual ~SemanticChangeEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const SemanticChangeEventTypeData_t& source);
...
private:
	...
	ArrayUA_t<SemanticChangeStructureDataType_t> changes;
...
public:
	...
	ArrayUA_t<SemanticChangeStructureDataType_t> &Changes(void) {return changes;}
...
#endif /* _SEMANTICCHANGEEVENTTYPEDATA_T_H_ */
