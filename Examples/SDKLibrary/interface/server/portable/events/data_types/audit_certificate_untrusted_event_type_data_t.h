...
#ifndef _AUDITCERTIFICATEUNTRUSTEDEVENTTYPEDATA_T_H_
#define _AUDITCERTIFICATEUNTRUSTEDEVENTTYPEDATA_T_H_
...
class AuditCertificateUntrustedEventTypeData_t : public AuditCertificateEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditCertificateUntrustedEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditCertificateUntrustedEventType;
	
	AuditCertificateUntrustedEventTypeData_t();
	virtual ~AuditCertificateUntrustedEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditCertificateUntrustedEventTypeData_t& source);
...
#endif /* _AUDITCERTIFICATEUNTRUSTEDEVENTTYPEDATA_T_H_ */
