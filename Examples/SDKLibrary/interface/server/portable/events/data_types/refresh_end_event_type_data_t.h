...
#ifndef _REFRESHENDEVENTTYPEDATA_T_H_
#define _REFRESHENDEVENTTYPEDATA_T_H_
...
class RefreshEndEventTypeData_t : public SystemEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(RefreshEndEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_RefreshEndEventType;
	
	RefreshEndEventTypeData_t();
	virtual ~RefreshEndEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const RefreshEndEventTypeData_t& source);
...
#endif /* _REFRESHENDEVENTTYPEDATA_T_H_ */
