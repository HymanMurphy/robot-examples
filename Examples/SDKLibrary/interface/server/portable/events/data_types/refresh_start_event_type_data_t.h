...
#ifndef _REFRESHSTARTEVENTTYPEDATA_T_H_
#define _REFRESHSTARTEVENTTYPEDATA_T_H_
...
class RefreshStartEventTypeData_t : public SystemEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(RefreshStartEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_RefreshStartEventType;
	
	RefreshStartEventTypeData_t();
	virtual ~RefreshStartEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const RefreshStartEventTypeData_t& source);
...
#endif /* _REFRESHSTARTEVENTTYPEDATA_T_H_ */
