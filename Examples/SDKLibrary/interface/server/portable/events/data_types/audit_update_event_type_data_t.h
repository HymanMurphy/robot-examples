...
#ifndef _AUDITUPDATEEVENTTYPEDATA_T_H_
#define _AUDITUPDATEEVENTTYPEDATA_T_H_
...
class AuditUpdateEventTypeData_t : public AuditEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditUpdateEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditUpdateEventType;
	
	AuditUpdateEventTypeData_t();
	virtual ~AuditUpdateEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditUpdateEventTypeData_t& source);
...
#endif /* _AUDITUPDATEEVENTTYPEDATA_T_H_ */
