...
#ifndef _AUDITCANCELEVENTTYPEDATA_T_H_
#define _AUDITCANCELEVENTTYPEDATA_T_H_
...
class AuditCancelEventTypeData_t : public AuditSessionEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditCancelEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditCancelEventType;
	
	AuditCancelEventTypeData_t();
	virtual ~AuditCancelEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditCancelEventTypeData_t& source);
...
private:
	...
	IntrusivePtr_t<UInt32_t> requestHandle;
	
	

public:
	//Accessors
	IntrusivePtr_t<const UInt32_t> RequestHandle(void) const {return requestHandle;}
	
	IntrusivePtr_t<UInt32_t> &RequestHandle(void) {return requestHandle;}
...
#endif /* _AUDITCANCELEVENTTYPEDATA_T_H_ */
