...
#ifndef _AUDITUPDATEMETHODEVENTTYPEDATA_T_H_
#define _AUDITUPDATEMETHODEVENTTYPEDATA_T_H_
...
class AuditUpdateMethodEventTypeData_t : public AuditEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditUpdateMethodEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditUpdateMethodEventType;
	
	AuditUpdateMethodEventTypeData_t();
	virtual ~AuditUpdateMethodEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditUpdateMethodEventTypeData_t& source);
...
public:
	//Accessors
	IntrusivePtr_t<const NodeId_t> MethodId(void) const {return methodId;}
	
	IntrusivePtr_t<NodeId_t> &MethodId(void) {return methodId;}
	
	
	
	ArrayUA_t<BaseDataType_t> &InputArguments(void) {return inputArguments;}
...
#endif /* _AUDITUPDATEMETHODEVENTTYPEDATA_T_H_ */
