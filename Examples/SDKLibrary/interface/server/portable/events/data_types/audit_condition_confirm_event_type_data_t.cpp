...
UA_DEFINE_RUNTIME_TYPE(AuditConditionConfirmEventTypeData_t, AuditConditionEventTypeData_t);

AuditConditionConfirmEventTypeData_t::AuditConditionConfirmEventTypeData_t()
{
}
...
bool AuditConditionConfirmEventTypeData_t::IsOfType(const uint32_t typeId, uint16_t namespaceindex) const
{
	if(namespaceindex != 0) return false;
	return typeId == 8961 || AuditConditionEventTypeData_t::IsOfType(typeId, namespaceindex);
}

Status_t AuditConditionConfirmEventTypeData_t::Initialise()
{
	Status_t rtnStatus = OpcUa_Good;
	browseName = new SafeRefCount_t<String_t>();
	UASDK_RETURN_OUT_OF_MEMORY_IF_NULL(browseName);
	rtnStatus = browseName->CopyFrom("AuditConditionConfirmEventType");
...
uint32_t AuditConditionConfirmEventTypeData_t::TypeId(uint16_t& namespaceIndex) const
{
	namespaceIndex = 0;
	return AuditConditionConfirmEventTypeData_t::TYPE_ID;
}

IntrusivePtr_t<BaseDataType_t> AuditConditionConfirmEventTypeData_t::AttributeValue(const uint32_t& typeId, const ArrayUA_t<QualifiedName_t>&browsePath, const uint32_t &_attributeId, const String_t& _indexRange, const ArrayUA_t<String_t> & locales,  Status_t &result)
{
	...
	IntrusivePtr_t<const BaseDataType_t> AuditConditionConfirmEventTypeData_t::AttributeValue(const uint32_t& typeId, const ArrayUA_t<QualifiedName_t>&browsePath, const uint32_t &_attributeId, const String_t& _indexRange, const ArrayUA_t<String_t> & locales, Status_t &result) const
	{
	...
	Status_t AuditConditionConfirmEventTypeData_t::CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const
	{
		return CopyToDestination(*this, destination);
	}
	
	Status_t AuditConditionConfirmEventTypeData_t::CopyFrom(const BaseDataType_t& source)
	{
		IntrusivePtr_t<const AuditConditionConfirmEventTypeData_t> ptr = RuntimeCast<const AuditConditionConfirmEventTypeData_t*>(source);
		if (!ptr.is_set())
		{
	...
	Status_t AuditConditionConfirmEventTypeData_t::CopyFrom(const AuditConditionConfirmEventTypeData_t& source)
	{
