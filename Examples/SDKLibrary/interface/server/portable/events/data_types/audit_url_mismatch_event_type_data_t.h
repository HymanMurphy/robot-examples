...
#ifndef _AUDITURLMISMATCHEVENTTYPEDATA_T_H_
#define _AUDITURLMISMATCHEVENTTYPEDATA_T_H_
...
class AuditUrlMismatchEventTypeData_t : public AuditCreateSessionEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditUrlMismatchEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditUrlMismatchEventType;
	
	AuditUrlMismatchEventTypeData_t();
	virtual ~AuditUrlMismatchEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditUrlMismatchEventTypeData_t& source);
...
private:
	...
	IntrusivePtr_t<String_t> endpointUrl;
	
	

public:
	//Accessors
	IntrusivePtr_t<const String_t> EndpointUrl(void) const {return endpointUrl;}
	
	IntrusivePtr_t<String_t> &EndpointUrl(void) {return endpointUrl;}
...
#endif /* _AUDITURLMISMATCHEVENTTYPEDATA_T_H_ */
