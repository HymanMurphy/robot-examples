...
UA_DEFINE_RUNTIME_TYPE(AuditConditionCommentEventTypeData_t, AuditConditionEventTypeData_t);

AuditConditionCommentEventTypeData_t::AuditConditionCommentEventTypeData_t()
{
}
...
bool AuditConditionCommentEventTypeData_t::IsOfType(const uint32_t typeId, uint16_t namespaceindex) const
{
	if(namespaceindex != 0) return false;
	return typeId == 2829 || AuditConditionEventTypeData_t::IsOfType(typeId, namespaceindex);
}

Status_t AuditConditionCommentEventTypeData_t::Initialise()
{
	Status_t rtnStatus = OpcUa_Good;
	browseName = new SafeRefCount_t<String_t>();
	UASDK_RETURN_OUT_OF_MEMORY_IF_NULL(browseName);
	rtnStatus = browseName->CopyFrom("AuditConditionCommentEventType");
...
uint32_t AuditConditionCommentEventTypeData_t::TypeId(uint16_t& namespaceIndex) const
{
	namespaceIndex = 0;
	return AuditConditionCommentEventTypeData_t::TYPE_ID;
}

IntrusivePtr_t<BaseDataType_t> AuditConditionCommentEventTypeData_t::AttributeValue(const uint32_t& typeId, const ArrayUA_t<QualifiedName_t>&browsePath, const uint32_t &_attributeId, const String_t& _indexRange, const ArrayUA_t<String_t> & locales,  Status_t &result)
{
	...
	IntrusivePtr_t<const BaseDataType_t> AuditConditionCommentEventTypeData_t::AttributeValue(const uint32_t& typeId, const ArrayUA_t<QualifiedName_t>&browsePath, const uint32_t &_attributeId, const String_t& _indexRange, const ArrayUA_t<String_t> & locales, Status_t &result) const
	{
	...
	Status_t AuditConditionCommentEventTypeData_t::CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const
	{
		return CopyToDestination(*this, destination);
	}
	
	Status_t AuditConditionCommentEventTypeData_t::CopyFrom(const BaseDataType_t& source)
	{
		IntrusivePtr_t<const AuditConditionCommentEventTypeData_t> ptr = RuntimeCast<const AuditConditionCommentEventTypeData_t*>(source);
		if (!ptr.is_set())
		{
	...
	Status_t AuditConditionCommentEventTypeData_t::CopyFrom(const AuditConditionCommentEventTypeData_t& source)
	{
