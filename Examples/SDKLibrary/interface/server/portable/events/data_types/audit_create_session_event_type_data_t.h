...
#ifndef _AUDITCREATESESSIONEVENTTYPEDATA_T_H_
#define _AUDITCREATESESSIONEVENTTYPEDATA_T_H_
...
class AuditCreateSessionEventTypeData_t : public AuditSessionEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditCreateSessionEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditCreateSessionEventType;
	
	AuditCreateSessionEventTypeData_t();
	virtual ~AuditCreateSessionEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditCreateSessionEventTypeData_t& source);
...
private:
	...
	IntrusivePtr_t<Duration_t> revisedSessionTimeout;
...
public:
	...
	IntrusivePtr_t<const Duration_t> RevisedSessionTimeout(void) const {return revisedSessionTimeout;}
	
	IntrusivePtr_t<Duration_t> &RevisedSessionTimeout(void) {return revisedSessionTimeout;}
...
#endif /* _AUDITCREATESESSIONEVENTTYPEDATA_T_H_ */
