...
#ifndef _AUDITCHANNELEVENTTYPEDATA_T_H_
#define _AUDITCHANNELEVENTTYPEDATA_T_H_
...
class AuditChannelEventTypeData_t : public AuditSecurityEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditChannelEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditChannelEventType;
	
	AuditChannelEventTypeData_t();
	virtual ~AuditChannelEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditChannelEventTypeData_t& source);
...
#endif /* _AUDITCHANNELEVENTTYPEDATA_T_H_ */
