...
#ifndef _AUDITCONDITIONCOMMENTEVENTTYPEDATA_T_H_
#define _AUDITCONDITIONCOMMENTEVENTTYPEDATA_T_H_
...
class AuditConditionCommentEventTypeData_t : public AuditConditionEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditConditionCommentEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditConditionCommentEventType;
	
	AuditConditionCommentEventTypeData_t();
	virtual ~AuditConditionCommentEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditConditionCommentEventTypeData_t& source);
...
#endif /* _AUDITCONDITIONCOMMENTEVENTTYPEDATA_T_H_ */
