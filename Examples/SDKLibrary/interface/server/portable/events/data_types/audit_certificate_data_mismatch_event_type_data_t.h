...
#ifndef _AUDITCERTIFICATEDATAMISMATCHEVENTTYPEDATA_T_H_
#define _AUDITCERTIFICATEDATAMISMATCHEVENTTYPEDATA_T_H_
...
class AuditCertificateDataMismatchEventTypeData_t : public AuditCertificateEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditCertificateDataMismatchEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditCertificateDataMismatchEventType;
	
	AuditCertificateDataMismatchEventTypeData_t();
	virtual ~AuditCertificateDataMismatchEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditCertificateDataMismatchEventTypeData_t& source);
...
private:
	...
	IntrusivePtr_t<String_t> invalidHostname;
	
	IntrusivePtr_t<String_t> invalidUri;
	
	

public:
	//Accessors
	IntrusivePtr_t<const String_t> InvalidHostname(void) const {return invalidHostname;}
	
	IntrusivePtr_t<String_t> &InvalidHostname(void) {return invalidHostname;}
	
	
	
	IntrusivePtr_t<const String_t> InvalidUri(void) const {return invalidUri;}
	
	IntrusivePtr_t<String_t> &InvalidUri(void) {return invalidUri;}
...
#endif /* _AUDITCERTIFICATEDATAMISMATCHEVENTTYPEDATA_T_H_ */
