...
#ifndef _AUDITCONDITIONEVENTTYPEDATA_T_H_
#define _AUDITCONDITIONEVENTTYPEDATA_T_H_
...
class AuditConditionEventTypeData_t : public AuditUpdateMethodEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditConditionEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditConditionEventType;
	
	AuditConditionEventTypeData_t();
	virtual ~AuditConditionEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditConditionEventTypeData_t& source);
...
#endif /* _AUDITCONDITIONEVENTTYPEDATA_T_H_ */
