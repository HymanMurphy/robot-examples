...
#ifndef _AUDITCERTIFICATEEVENTTYPEDATA_T_H_
#define _AUDITCERTIFICATEEVENTTYPEDATA_T_H_
...
class AuditCertificateEventTypeData_t : public AuditSecurityEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditCertificateEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditCertificateEventType;
	
	AuditCertificateEventTypeData_t();
	virtual ~AuditCertificateEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditCertificateEventTypeData_t& source);
...
#endif /* _AUDITCERTIFICATEEVENTTYPEDATA_T_H_ */
