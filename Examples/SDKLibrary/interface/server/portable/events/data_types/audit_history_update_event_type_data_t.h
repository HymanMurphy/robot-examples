...
#ifndef _AUDITHISTORYUPDATEEVENTTYPEDATA_T_H_
#define _AUDITHISTORYUPDATEEVENTTYPEDATA_T_H_
...
class AuditHistoryUpdateEventTypeData_t : public AuditUpdateEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditHistoryUpdateEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditHistoryUpdateEventType;
	
	AuditHistoryUpdateEventTypeData_t();
	virtual ~AuditHistoryUpdateEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditHistoryUpdateEventTypeData_t& source);
...
private:
	...
	IntrusivePtr_t<NodeId_t> parameterDataTypeId;
	
	

public:
	//Accessors
	IntrusivePtr_t<const NodeId_t> ParameterDataTypeId(void) const {return parameterDataTypeId;}
	
	IntrusivePtr_t<NodeId_t> &ParameterDataTypeId(void) {return parameterDataTypeId;}
...
#endif /* _AUDITHISTORYUPDATEEVENTTYPEDATA_T_H_ */
