...
#ifndef _REFRESHREQUIREDEVENTTYPEDATA_T_H_
#define _REFRESHREQUIREDEVENTTYPEDATA_T_H_
...
class RefreshRequiredEventTypeData_t : public SystemEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(RefreshRequiredEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_RefreshRequiredEventType;
	
	RefreshRequiredEventTypeData_t();
	virtual ~RefreshRequiredEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const RefreshRequiredEventTypeData_t& source);
...
#endif /* _REFRESHREQUIREDEVENTTYPEDATA_T_H_ */
