...
#ifndef _AUDITSECURITYEVENTTYPEDATA_T_H_
#define _AUDITSECURITYEVENTTYPEDATA_T_H_
...
class AuditSecurityEventTypeData_t : public AuditEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditSecurityEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditSecurityEventType;
	
	AuditSecurityEventTypeData_t();
	virtual ~AuditSecurityEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditSecurityEventTypeData_t& source);
...
#endif /* _AUDITSECURITYEVENTTYPEDATA_T_H_ */
