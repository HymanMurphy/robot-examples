...
#ifndef _AUDITCONDITIONENABLEEVENTTYPEDATA_T_H_
#define _AUDITCONDITIONENABLEEVENTTYPEDATA_T_H_
...
class AuditConditionEnableEventTypeData_t : public AuditConditionEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditConditionEnableEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditConditionEnableEventType;
	
	AuditConditionEnableEventTypeData_t();
	virtual ~AuditConditionEnableEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditConditionEnableEventTypeData_t& source);
...
#endif /* _AUDITCONDITIONENABLEEVENTTYPEDATA_T_H_ */
