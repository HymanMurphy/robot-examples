...
#ifndef _SYSTEMOFFNORMALALARMTYPEDATA_T_H_
#define _SYSTEMOFFNORMALALARMTYPEDATA_T_H_
...
class SystemOffNormalAlarmTypeData_t : public OffNormalAlarmTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(SystemOffNormalAlarmTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_SystemOffNormalAlarmType;
	
	SystemOffNormalAlarmTypeData_t();
	virtual ~SystemOffNormalAlarmTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const SystemOffNormalAlarmTypeData_t& source);
...
#endif /* _SYSTEMOFFNORMALALARMTYPEDATA_T_H_ */
