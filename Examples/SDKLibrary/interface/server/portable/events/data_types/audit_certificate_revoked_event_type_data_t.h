...
#ifndef _AUDITCERTIFICATEREVOKEDEVENTTYPEDATA_T_H_
#define _AUDITCERTIFICATEREVOKEDEVENTTYPEDATA_T_H_
...
class AuditCertificateRevokedEventTypeData_t : public AuditCertificateEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditCertificateRevokedEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditCertificateRevokedEventType;
	
	AuditCertificateRevokedEventTypeData_t();
	virtual ~AuditCertificateRevokedEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditCertificateRevokedEventTypeData_t& source);
...
#endif /* _AUDITCERTIFICATEREVOKEDEVENTTYPEDATA_T_H_ */
