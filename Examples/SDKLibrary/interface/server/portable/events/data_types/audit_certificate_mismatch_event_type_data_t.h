...
#ifndef _AUDITCERTIFICATEMISMATCHEVENTTYPEDATA_T_H_
#define _AUDITCERTIFICATEMISMATCHEVENTTYPEDATA_T_H_
...
class AuditCertificateMismatchEventTypeData_t : public AuditCertificateEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditCertificateMismatchEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditCertificateMismatchEventType;
	
	AuditCertificateMismatchEventTypeData_t();
	virtual ~AuditCertificateMismatchEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditCertificateMismatchEventTypeData_t& source);
...
#endif /* _AUDITCERTIFICATEMISMATCHEVENTTYPEDATA_T_H_ */
