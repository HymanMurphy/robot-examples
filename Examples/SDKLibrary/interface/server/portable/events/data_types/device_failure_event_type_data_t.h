...
#ifndef _DEVICEFAILUREEVENTTYPEDATA_T_H_
#define _DEVICEFAILUREEVENTTYPEDATA_T_H_
...
class DeviceFailureEventTypeData_t : public SystemEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(DeviceFailureEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_DeviceFailureEventType;
	
	DeviceFailureEventTypeData_t();
	virtual ~DeviceFailureEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const DeviceFailureEventTypeData_t& source);
...
#endif /* _DEVICEFAILUREEVENTTYPEDATA_T_H_ */
