...
#ifndef _DISCRETEALARMTYPEDATA_T_H_
#define _DISCRETEALARMTYPEDATA_T_H_
...
class DiscreteAlarmTypeData_t : public AlarmConditionTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(DiscreteAlarmTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_DiscreteAlarmType;
	
	DiscreteAlarmTypeData_t();
	virtual ~DiscreteAlarmTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const DiscreteAlarmTypeData_t& source);
...
#endif /* _DISCRETEALARMTYPEDATA_T_H_ */
