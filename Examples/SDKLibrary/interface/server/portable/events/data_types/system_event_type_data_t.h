...
#ifndef _SYSTEMEVENTTYPEDATA_T_H_
#define _SYSTEMEVENTTYPEDATA_T_H_
...
class SystemEventTypeData_t : public BaseEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(SystemEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_SystemEventType;
	
	SystemEventTypeData_t();
	virtual ~SystemEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const SystemEventTypeData_t& source);
...
#endif /* _SYSTEMEVENTTYPEDATA_T_H_ */
