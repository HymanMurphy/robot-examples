...
#ifndef _AUDITCERTIFICATEINVALIDEVENTTYPEDATA_T_H_
#define _AUDITCERTIFICATEINVALIDEVENTTYPEDATA_T_H_
...
class AuditCertificateInvalidEventTypeData_t : public AuditCertificateEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(AuditCertificateInvalidEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_AuditCertificateInvalidEventType;
	
	AuditCertificateInvalidEventTypeData_t();
	virtual ~AuditCertificateInvalidEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const AuditCertificateInvalidEventTypeData_t& source);
...
#endif /* _AUDITCERTIFICATEINVALIDEVENTTYPEDATA_T_H_ */
