...
#ifndef _SYSTEMSTATUSCHANGEEVENTTYPEDATA_T_H_
#define _SYSTEMSTATUSCHANGEEVENTTYPEDATA_T_H_
...
class SystemStatusChangeEventTypeData_t : public SystemEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(SystemStatusChangeEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_SystemStatusChangeEventType;
	
	SystemStatusChangeEventTypeData_t();
	virtual ~SystemStatusChangeEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const SystemStatusChangeEventTypeData_t& source);
...
private:
	...
	IntrusivePtr_t<Int32_t> systemState_serverState;
	
	IntrusivePtr_t<ServerState_t> systemState;
	
	

public:
	//Accessors
	IntrusivePtr_t<const Int32_t> SystemState_ServerState(void) const {return systemState_serverState;}
	
	IntrusivePtr_t<Int32_t> &SystemState_ServerState(void) {return systemState_serverState;}
	
	
	
	IntrusivePtr_t<const ServerState_t> SystemState(void) const {return systemState;}
	
	IntrusivePtr_t<ServerState_t> &SystemState(void) {return systemState;}
...
#endif /* _SYSTEMSTATUSCHANGEEVENTTYPEDATA_T_H_ */
