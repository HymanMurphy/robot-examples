...
#ifndef _BASEMODELCHANGEEVENTTYPEDATA_T_H_
#define _BASEMODELCHANGEEVENTTYPEDATA_T_H_
...
class BaseModelChangeEventTypeData_t : public BaseEventTypeData_t
{
public:
	UA_DECLARE_RUNTIME_TYPE(BaseModelChangeEventTypeData_t);
	
	static const uint32_t TYPE_ID = OpcUaId_BaseModelChangeEventType;
	
	BaseModelChangeEventTypeData_t();
	virtual ~BaseModelChangeEventTypeData_t();
	
	virtual Status_t CopyTo(IntrusivePtr_t<BaseDataType_t>& destination) const;
	virtual Status_t CopyFrom(const BaseDataType_t& source);
	Status_t CopyFrom(const BaseModelChangeEventTypeData_t& source);
...
#endif /* _BASEMODELCHANGEEVENTTYPEDATA_T_H_ */
